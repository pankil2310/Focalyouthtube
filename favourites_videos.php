...
if($session_id == "")
{
    ...
    $liked_sql = mysqli_query($connect,"SELECT * FROM `add_to_fav` WHERE `user_id` = '$session_id'");  
    ...
    <section class="gen-section-padding-3 grid_video" style="margin-top:50px;">
        <div class="container container-2">
                     ...
                     <div class="gen-style-2 videoitems">               
                          ...
                          {
                               echo "<div class='gen-style-2 videoitems' style='text-align:center;color:#1261a0'>Favourite Videos Not Available.</div>";
                          }
                           ?>                        
                     </div>
