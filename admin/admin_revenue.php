                  ...
                  <table id="basic-datatable" class="table table-striped dt-responsive nowrap dataTable no-footer dtr-inline" role="grid" aria-describedby="basic-datatable_info" style="position: relative;">
                        ...
                        <tbody>
                           ...
                           if($_POST['from'])
                                 {
                                    ...
                                    if($_POST['to'])
                                    {
                                       ...
                                       $enroll_course_sql = mysqli_query($connect,"SELECT * FROM `course_enroll` WHERE `start_date` BETWEEN '$from' AND '$to'");                                                                                                                
                                    }   
                                    else
                                    {
                                       $enroll_course_sql = mysqli_query($connect,"SELECT * FROM `course_enroll` WHERE `start_date` = '$from'");                                                                                                            
                                    }                              
                                 }
                                 else
                                 {
                                    $enroll_course_sql = mysqli_query($connect,"SELECT * FROM `course_enroll`");
                                 }
                           ...
                           <tr class="gradeU">
                              ...
                              $course_sql = mysqli_query($connect,"SELECT * FROM `courses` WHERE `course_code` = '$course_code'");
