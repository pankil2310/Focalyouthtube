...
if($session_id == "")
{
    ...
    $liked_sql = mysqli_query($connect,"SELECT * FROM `course_like` WHERE `user_id` = '$session_id' AND `course_like` = '0'");  
   while($row = mysqli_fetch_assoc($liked_sql))
   {
    ...
    <section class="gen-section-padding-3 grid_video" style="margin-top:50px;">
        <div class="container container-2">
                     ...
                     <div class="gen-style-2 videoitems">               
                                          ...
                                          <div id="videosList">           
                                             <div class="video" style=" background-image: url('<?=$row1['course_thumbanil']?>');background-size: cover;background-position: center center;">
                                                <video class="thevideo" loop preload="none" >
                                                   <source src="<?=$row1['course_short_video']?>">
                          ...
                          {
                               echo "<div class='gen-style-2 videoitems' style='text-align:center;color:#1261a0'>Liked Videos Not Available.</div>";
                          }
                           ?>                        
                     </div>
